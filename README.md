...
- This class handles categorical data as it is described in the books: ![equation](http://www.codecogs.com/eqnedit.php?latex=2^{q-1}-1) possible splits (for q categories). 
